...
Giả sử bạn đã thực hiện nhiều thay đổi đến một file và muốn nó hiển thị trong những commit riêng biệt. Trong trường hợp này, chúng ta thêm những file đó bằng tiền tố ```-p``` vào lệnh add của chúng ta.
